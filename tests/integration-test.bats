...
@test "builds temp-table correctly" {
    cat examples/temp-table.n | sbcl --script src/c-cli.lisp > gen/temp-table.c
...
@test "builds pipe correctly" {
    cat examples/pipe.n | sbcl --script src/c-cli.lisp > gen/pipe.c
...
@test "builds wc correctly" {
    cat examples/wc.n | sbcl --script src/c-cli.lisp > gen/wc.c
...
@test "builds character-counter correctly" {
    cat examples/character-counter.n | sbcl --script src/c-cli.lisp > gen/character-counter.c
...
@test "builds print-longest-line correctly" {
    cat examples/print-longest-line.n | sbcl --script src/c-cli.lisp > gen/print-longest-line.c
...
@test "builds bitcount correctly" {
    cat examples/bitcount.n | sbcl --script src/c-cli.lisp > gen/bitcount.c
